...
var SearchBox = /** @class */ (function (_super) {
    ...
    SearchBox.prototype.render = function () {
        ...
        results.sort(function (a, b) {
            return a.item.depth > b.item.depth ? 1 : a.item.depth < b.item.depth ? -1 : b.score - a.score;
        });
        return (React.createElement("div", { className: this.props.className },
            this.state.term && React.createElement(ClearIcon, { onClick: this.clear }, "\u00D7"),
            ...
            results.length > 0 && (React.createElement(SearchResultsBox, null, results.map(function (res) { return (React.createElement(MenuItem_1.MenuItem, { item: res.item, onActivate: _this.props.onActivate, withoutChildren: true, key: res.item.id })); })))));
    };
    return SearchBox;
}(React.PureComponent));
